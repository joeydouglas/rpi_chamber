...
all_sensors = ['sensor1_internal', 'sensor2_internal', 'sensor1_external', 'sensor2_external']
...
def sensorReading():
  print sensors[0]
  print sensor1_internal
  print sensor1
  humidity, temperature = Adafruit_DHT.read_retry(sensor1_internal, sensor1_internal_pin)
